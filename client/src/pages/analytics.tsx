...
export default function AnalyticsPage() {
  ...
  const exportToPDF = async () => {
    ...
    const addFooter = (pdf: jsPDF) => {
      ...
      pdf.setFontSize(10);
      pdf.setFont('helvetica', 'normal');
      pdf.text('Generated by ProCoach - Professional Football Team Management System', 20, pageHeight - 10);
      pdf.text(`www.procoach.app | © ${new Date().getFullYear()} ProCoach`, pdf.internal.pageSize.width - 80, pageHeight - 10);
    };
