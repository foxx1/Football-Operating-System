        ...
        {statsCards.map((stat, index) => {
          ...
          return (
            <Link key={index} href={stat.link} data-testid={`stats-card-${stat.title.toLowerCase().replace(/\s+/g, '-')}`}>
              <Card className="stats-card cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105">
                <CardContent className="p-6">
              ...
              <div className="space-y-4">
                {upcomingSessions.map((session, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg hover:bg-muted transition-colors cursor-pointer" data-testid={`session-${index}`}>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  ...
                  >
                    <div className="flex items-start space-x-4 hover:bg-muted/50 p-2 rounded-lg transition-colors cursor-pointer" data-testid={`activity-${index}`}>
                ...
                <div className="pt-4 border-t border-border">
                  ...
                  <div className="space-y-3">
                    {topPerformers.map((player, index) => (
                      ...
                      >
                        <div className="flex items-center space-x-3 hover:bg-muted/50 p-2 rounded-lg transition-colors cursor-pointer" data-testid={`top-performer-${index}`}>
