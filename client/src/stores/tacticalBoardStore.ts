...
const defaultFormations: Formation[] = [
  ...
  },
  {
    ...
    popularity: 88,
    players: [
      { id: '12', name: 'GK', number: 1, position: 'Goalkeeper', x: 50, y: 90, team: 'home', color: '#ef4444', icon: '🥅' },
      { id: '13', name: 'RB', number: 2, position: 'Right Back', x: 20, y: 70, team: 'home', color: '#ef4444', icon: '🛡️' },
      { id: '14', name: 'CB', number: 3, position: 'Center Back', x: 40, y: 70, team: 'home', color: '#ef4444', icon: '🛡️' },
      { id: '15', name: 'CB', number: 4, position: 'Center Back', x: 60, y: 70, team: 'home', color: '#ef4444', icon: '🛡️' },
      { id: '16', name: 'LB', number: 5, position: 'Left Back', x: 80, y: 70, team: 'home', color: '#ef4444', icon: '🛡️' },
      { id: '17', name: 'CDM', number: 6, position: 'Defensive Midfielder', x: 50, y: 55, team: 'home', color: '#ef4444', icon: '⚙️' },
      { id: '18', name: 'CM', number: 8, position: 'Central Midfielder', x: 35, y: 45, team: 'home', color: '#ef4444', icon: '⚙️' },
      { id: '19', name: 'CM', number: 10, position: 'Attacking Midfielder', x: 65, y: 45, team: 'home', color: '#ef4444', icon: '⚙️' },
      { id: '20', name: 'LW', number: 7, position: 'Left Winger', x: 25, y: 25, team: 'home', color: '#ef4444', icon: '🏃' },
      { id: '21', name: 'ST', number: 9, position: 'Striker', x: 50, y: 25, team: 'home', color: '#ef4444', icon: '⚽' },
      { id: '22', name: 'RW', number: 11, position: 'Right Winger', x: 75, y: 25, team: 'home', color: '#ef4444', icon: '🏃' },
    ]
  },
  {
    id: '3-5-2',
