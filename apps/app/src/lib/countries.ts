...
export const countries: Country[] = [
  ...
  { code: 'CC', name: 'Cocos Islands', flag: '🇨🇨', phoneCode: '+61' },
  ...
  { code: 'HM', name: 'Heard Island', flag: '🇭🇲', phoneCode: '+672' },
  ...
  { code: 'VG', name: 'British Virgin Islands', flag: '🇻🇬', phoneCode: '+1284' },
  { code: 'VI', name: 'United States Virgin Islands', flag: '🇻🇮', phoneCode: '+1340' },
